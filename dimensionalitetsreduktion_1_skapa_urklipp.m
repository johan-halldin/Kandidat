...
sheetPD = xlsread(sheet, 'F:F');    %l?ser in Perinatal Death fr?n excellfil
sheetODFD = xlsread(sheet, 'G:G');    %l?ser in ODFD fr?n excellfil
sheetFCAO = xlsread(sheet, 'H:H');    
sheetNICU = xlsread(sheet, 'I:I');    
